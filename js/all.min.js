...
//scroll header
var headerWrap = document.querySelector('.header-wrapper');
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var _loop2 = function _loop2() {
    var mySplide = new Splide(elms[i], {
      mediaQuery: 'min',
      pagination: false,
      arrows: false,
      autoWidth: true,
  ...
  var _loop3 = function _loop3() {
    var mySplide = new Splide(desctopSplide[i], {
      mediaQuery: 'min',
      pagination: false,
      autoWidth: true,
      gap: '1.9rem',
...
var btnPhone = document.querySelector('.ico-phone'),
...
//table scroll
var tableContainer = document.querySelector('.table-conteiner'),
...
var scrollToLlink = document.querySelectorAll('.scroll-to');
scrollToLlink.forEach(function (link) {
  link.addEventListener('click', function () {
    var dataSection = this.dataset.href;
